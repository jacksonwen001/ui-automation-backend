...
from schemas.page import CreatePageRequest, QueryPageRequest, QueryPageResponse, UpdatePageRequest
...
@router.get('')
async def query(*, request: Annotated[QueryPageRequest, Depends()], db: Session = Depends(get_db)) -> QueryPageResponse: 
    page_service.query(db, request)
