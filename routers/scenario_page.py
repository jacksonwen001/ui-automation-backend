...
from schemas.scenario_page import CreateScenarioPageRequest, QueryScenarioPageResponse
...
@router.get('')
async def query(*, db:Session=Depends(get_db), scenario_id: str) -> QueryScenarioPageResponse: 
