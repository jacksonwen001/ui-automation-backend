...
from schemas.scenario_page import CreateScenarioPageRequest, QueryScenarioPageResponse, QueryScenarioPagesResponse
...
@router.get('')
async def query(*, db:Session=Depends(get_db), scenario_id: str) -> QueryScenarioPagesResponse: 
    return scenario_page_service.display(db=db, scenario_id=scenario_id)
